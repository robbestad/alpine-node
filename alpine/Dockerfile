# Inspired by https://github.com/mhart/alpine-node/blob/master/Dockerfile
FROM docker.nrk.no/linuxadmin/alpine_baseimage:22

ENV VERSION=v4.4.5 NPM_VERSION=2.15.6
